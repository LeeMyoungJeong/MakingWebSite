 ...
 *    ex) @XXXMapping("/board/read/{boardNo}") --> 중괄호 안에 사용할 매개변수의 이름을 입력
 *        @Pathvariable int boardNo  --> 경로로 넘어온 값을 변수에 넣어준다. 
 *        
 * - /board/read?boardNo=10  --> 쿼리스트링 뒤에 요청 매개변수 = 값 입력했음.
 * - /board/read/10  --> 결국 게시글 번호를 받고 싶지만 경로에 게시글 번호를 입력하여 게시글을 가져올 수 있게
 *   //                  할 수도 있음.
 * 
 * 
 * @author h
