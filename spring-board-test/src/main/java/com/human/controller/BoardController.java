...
//import com.human.domain.dao.BoardDAO;
...
public class BoardController {
	...
	public String list(Model model, Page page) throws Exception {
		...
		/*     BoardMapper.xml 의 listWithPage 가
		 * 	   BoardMapper에게 호출당함.
		 *     그것을 BoardServiceImpl에서 호출하여 boardList에 반환받음
		 *     그리고 그것을 최초로 호출하는 것은 controller --> list(page)
		 *     그럼 페이징 처리가 된 boardList가 조회됨
		 * 
		 * 
		 * 
		 */
		
		model.addAttribute("page", page);  // -- 여기까지 하면 게시판에 10개씩 딱 나뉘어 출력됨
